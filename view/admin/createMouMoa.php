    ...
    <div class="form-card mx-auto col-md-8 shadow">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="jurusan[]" value="Administrasi Niaga" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault">
                        Administrasi Niaga
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="jurusan[]" value="Bahasa Inggris" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault">
                        Bahasa Inggris
                    </label>
                </div>
